...
// 		final UrlMap urlMap = UrlMap.builder().longUrl(longUrl).shortUrlHash(shortUrl).build();
// 		urlRepo.save(urlMap);
...
// 		final List<UrlMap> longUrls = urlRepo.findByShortUrlHash(shortUrlHash);
...
// 		final List<UrlMap> urlMaps = urlRepo.findByShortUrlHash(shortUrl);
// 		if (urlMaps.isEmpty()) {
// 			return null;
// 		}
...
// 		final Optional<UrlMap> opnl = urlRepo.findById(longUrl);
